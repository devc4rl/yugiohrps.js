...
async function getRandomCardId(){
    // floor para arredondar, random para escolher um aleatório e lenght para pegar o tamanho
...
async function createCardImage(IdCard, fieldSide){
    ...
    cardImage.classList.add("card"); //para personalizar no css

    if(fieldSide === playerSides.player1){
        cardImage.addEventListener("click", () => {
            //colocar no centro a carta clicada
